...
const CALLBACK_DEBOUNCE_WAIT = parseInt( process.env.CALLBACK_DEBOUNCE_WAIT || '2000', 10 );
const CALLBACK_DEBOUNCE_MAXWAIT = parseInt( process.env.CALLBACK_DEBOUNCE_MAXWAIT || '10000', 10 );
 ...
 */
export const setContentInitializor = _contentInitializor => {
	contentInitializor = _contentInitializor;
};
