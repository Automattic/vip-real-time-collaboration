...
This plugin is built on top of the `add/yjs-entity-improvement` branch, from our Gutenberg fork [here](https://github.com/Automattic/gutenberg/tree/add/yjs-entity-improvement).
