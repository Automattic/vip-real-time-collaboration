 ...
 *
 * This class disables the post lock dialogue in the Block Editor,
 * allowing multiple users to edit the same post simultaneously.
 *
 * There is an additional override in JS which was added in v21.2.0 (Gutenberg), through /src/utils/lock-modal.js.
 */
