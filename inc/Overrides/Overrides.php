...
final class Overrides {
	...
	public function add_autosave_cron(): void {
		if ( false === wp_next_scheduled( 'vip_real_time_collaboration_autosave_cron' ) ) {
			wp_schedule_event( time(), 'daily', 'vip_real_time_collaboration_autosave_cron' );
		}

		add_action( 'vip_real_time_collaboration_autosave_cron', [ $this, 'handle_autosave_cron' ] );
	}
