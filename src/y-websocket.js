	...
	constructor(
		...
		this._updateHandler = ( update, origin ) => {
			if ( origin !== this ) {
				...
				const messageArray = encoding.toUint8Array( encoder );
				const theDecoder = decoding.createDecoder( messageArray );
				const decMessage = decoding.peekVarString( theDecoder );
				console.log( 'sending message', decMessage );

				broadcastMessage( this, messageArray );
			}
		};
